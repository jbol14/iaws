 ...
 * 
 */
@WebServiceClient(name = "MarketWSService", targetNamespace = "http://market.wi3.meclab.in.tuc.de/", wsdlLocation = "http://localhost:8082/MarketWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MARKETWSSERVICE_QNAME = new QName("http://market.wi3.meclab.in.tuc.de/", "MarketWSService");
    ...
    public MarketWS getMarketWSPort() {
        return super.getPort(new QName("http://market.wi3.meclab.in.tuc.de/", "MarketWSPort"), MarketWS.class);
    }
    ...
    public MarketWS getMarketWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://market.wi3.meclab.in.tuc.de/", "MarketWSPort"), MarketWS.class, features);
    }
